...
import { fetchCategories, updateCategory } from '../../../features/categories/categoryThunks';  // Assuming `updateCategory` is in `categoryThunks`
...
const EditCategory = () => {
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            if (parentIdInt && !isNaN(parentIdInt)) {
                updatedCategory.parentId = parentIdInt;
            } else {
